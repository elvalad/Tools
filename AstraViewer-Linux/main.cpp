...
{
    cout << " *********** Astra Viewer v1.5*********" << endl << endl;
    ...
    std::vector<IplImage> imgsOne(1);
    std::vector<IplImage> imgsTwo(2);
    CvFont font;
    ...
    while (true)
    {
		...
		{
			camera.IRConvertWORD2BYTE(cvIRImg, c24bitIR);
		}
