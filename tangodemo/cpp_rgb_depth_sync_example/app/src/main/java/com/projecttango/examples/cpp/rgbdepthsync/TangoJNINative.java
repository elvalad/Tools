...
public class TangoJNINative {
  ...
  public static native void setMirror(boolean on);

  public static native void setDepthCapturing(boolean on);

  public static native void setCenterRegionDepthCapturing(boolean on);

  public static native void onDisplayChanged(int displayRotation, int colorCameraRotation);

  public static native String getCenterPointDepth();
