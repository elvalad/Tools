...
void SynchronizationApplication::OnDrawFrame() {
  ...
  // Add the rotation mirror function
 if (mirror_) {
    switch(color_camera_to_display_rotation_) {
      case TangoSupportDisplayRotation::ROTATION_0:
        color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_0_MIRROR;
        break;
      case TangoSupportDisplayRotation::ROTATION_90:
        color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_90_MIRROR;
        break;
      case TangoSupportDisplayRotation::ROTATION_180:
        color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_180_MIRROR;
        break;
      case TangoSupportDisplayRotation::ROTATION_270:
        color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_270_MIRROR;
        break;
    }
 } else {
     switch(color_camera_to_display_rotation_) {
       case TangoSupportDisplayRotation::ROTATION_0:
       case TangoSupportDisplayRotation::ROTATION_0_MIRROR:
         color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_0;
         break;
       case TangoSupportDisplayRotation::ROTATION_90:
       case TangoSupportDisplayRotation::ROTATION_90_MIRROR:
         color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_90;
         break;
       case TangoSupportDisplayRotation::ROTATION_180:
       case TangoSupportDisplayRotation::ROTATION_180_MIRROR:
         color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_180;
         break;
       case TangoSupportDisplayRotation::ROTATION_270:
       case TangoSupportDisplayRotation::ROTATION_270_MIRROR:
         color_camera_to_display_rotation_ = TangoSupportDisplayRotation::ROTATION_270;
         break;
     }
 }
...
void SynchronizationApplication::SetMirror(bool on) {
    mirror_ = on;
}

void SynchronizationApplication::SetDepthCapturing(bool on) {
    depth_image_.SetDepthDataCapturing(on);
}

void SynchronizationApplication::SetCenterRegionDepthCapturing(bool on) {
    depth_image_.SetCenterRegionDepthDataCapturing(on);
}
...
std::string SynchronizationApplication::GetCenterPointDepth() {
  float depth = depth_image_.GetCenterPointDepth();
  std::ostringstream strs;
  strs << "Center Point Depth : " << depth << " meters";
