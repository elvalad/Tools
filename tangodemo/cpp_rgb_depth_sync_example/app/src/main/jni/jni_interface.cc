...
JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_setMirror(
    JNIEnv*, jobject, jboolean on) {
  return app.SetMirror(on);
}

JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_setDepthCapturing(
    JNIEnv*, jobject, jboolean on) {
  return app.SetDepthCapturing(on);
}

JNIEXPORT void JNICALL
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_setCenterRegionDepthCapturing(
    JNIEnv*, jobject, jboolean on) {
  return app.SetCenterRegionDepthCapturing(on);
}
...
Java_com_projecttango_examples_cpp_rgbdepthsync_TangoJNINative_getCenterPointDepth(
    JNIEnv* env, jobject) {
  return (env)->NewStringUTF(app.GetCenterPointDepth().c_str());
}
