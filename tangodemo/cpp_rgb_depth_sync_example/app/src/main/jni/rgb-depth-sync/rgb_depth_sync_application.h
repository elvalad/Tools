...
class SynchronizationApplication {
 public:
  ...
  // Set mirror color and depth image
  void SetMirror(bool on);

  // Set whether to capture depth image data
  void SetDepthCapturing(bool on);

  // Set whether to capture center region image data
  void SetCenterRegionDepthCapturing(bool on);
  ...
  std::string GetCenterPointDepth();
